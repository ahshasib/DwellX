    ...
    return (
        <div className="h-screen w-full">
            ...
            <div className="relative min-h-screen w-full overflow-hidden">
                ...
                {/* Main Content */}
                <div className="relative z-20 flex flex-col items-center justify-center text-center px-4 py-10 sm:py-16 md:py-24">
                    
                    {/* Badge */}
                    <span className="inline-flex items-center gap-2 py-2 px-4 text-sm sm:text-base bg-white border border-indigo-100 text-indigo-500 rounded-full shadow-sm">
                    ...
                    {/* Subtitle */}
                    <p className="text-base sm:text-lg md:text-xl max-w-3xl mt-4 text-black font-semibold px-2">
                    ...
                    {/* Category & Search Box */}
                    <div className="mt-12 w-full max-w-4xl bg-white rounded-3xl py-8 px-4 sm:px-6 md:px-10 shadow-2xl">
                        
                        {/* Category Buttons */}
                        <div className="flex flex-wrap justify-center gap-3 mb-6">
                            {["🏢 Apartments", "🏠 Houses", "🏡 Villas", "🛏️ Studios"].map((label, i) => (
                                <span
                                    key={i}
                    ...
                    {/* Last sparkle button slightly higher */}
